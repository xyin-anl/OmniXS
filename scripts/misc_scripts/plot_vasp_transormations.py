## ============================================================================
## VESTIGIAL CODE: use code in src/vasp_data_transformations.py instead
## ============================================================================
...
#         l_trunc += f"{self.e_cbm:.2f} - {self.e_core:.2f} "
#         l_trunc += r"\text{eV}$\\ "
#         l_trunc += r"$E_{\text{min}} = "
...
#         l_align += r"$\Delta E = $" f"{self.thoeretical_offset:.2f} \n"
#         return l_align
#
#     def plot(self):
...
#         self.truncate()
#         ax[1].plot(self.energy, self.spectra, label=self.legend_truncation())
#         self.scale()
#         ax[2].plot(self.energy, self.spectra, label=self.legend_scaling())
#         self.broaden()
#         ax[3].plot(self.energy, self.spectra, label=self.legend_broadening())
#         self.align()
#         ax[4].plot(self.energy, self.spectra, label=self.legend_alignment())
#         # ax[5].plot(self.energy, self.spectra, label="brodened", linewidth=2)
#         # ax[5].plot(self.energy, self.spectra, label="no_brodening", alpha=0.5)
#
#         for axis in ax:
#             axis.legend(
#                 loc="center left",
