...
exafsFigure.suptitle(f"EXAFS of {compound}", fontsize=FONTSIZE, x=0.5, y=0.925)
...
plt.suptitle(f"Peak location distribution of {compound}", fontsize=FONTSIZE)
...
axs[1].axis("off")
fig.tight_layout()
fig.savefig(f"exafs_combined_{compound}.pdf", bbox_inches="tight", dpi=300)
